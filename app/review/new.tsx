...
export default function ReviewDetail() {
  ...
  async function openAlbum() {
    ...
    // New-format reviews already know their type — no guessing needed.
    if (entry.itemType === 'track' && entry.parentAlbumId) {
      router.push({
        pathname: `/album/${entry.parentAlbumId}` as any,
    ...
    // Fallback for older reviews saved before itemType existed.
